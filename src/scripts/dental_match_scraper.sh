...
nohup bash /home/airflow/gcs/data/main_jobs_gcp_single_run.sh $project_id vm-dental-match $service_account $gcs_bucket main_scrape_dental_match.py  >  ../data/$(date "+%Y-%m-%d-%H-%M-%S-")nohup-dental-match.out
