...
nohup bash /home/airflow/gcs/data/main_jobs_gcp_single_run.sh $project_id vm-diamond-dental-url $service_account $gcs_bucket scrape_diamond_dental_staff_job_url.py  >  ../data/$(date "+%Y-%m-%d-%H-%M-%S-")nohup-job-url-diamond-dental-staff.out
